...
class Team(models.Model):
    ...
    leader = models.ForeignKey(
        UserModel, on_delete=models.CASCADE, related_name='leading_teams')
...
class Task(models.Model):
    ...
    status = models.CharField(
        max_length=4, choices=STATUS_CHOICES, default='PLAN')
    ...
    assigned_to = models.ManyToManyField(
        UserModel, help_text="Press ctrl to select multiple")
    ...
    accepted_by = models.ForeignKey(
        UserModel, on_delete=models.SET_NULL, null=True, related_name='accepted_tasks', blank=True)
